...
export function PaymentForm() {
  // Commenting out Stripe implementation while using Calendly's payment integration
  // To re-enable custom Stripe implementation, uncomment this code
...
// Temporary simplified version that redirects directly to Calendly
export function PaymentForm() {
  return (
    <div className="max-w-md mx-auto p-6">
      <button 
