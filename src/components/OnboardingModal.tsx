...
import { FileQuestion, FileText, Target, PlusCircle, Award, ChevronLeft, X } from 'lucide-react';
...
const onboardingSteps: OnboardingStep[] = [
  {
    title: 'Unit MCQs',
    description: 'Practice multiple choice questions organized by unit to master key concepts.',
    icon: FileQuestion,
  },
  {
    title: 'Unit FRQs',
    description: 'Tackle free response questions to develop your analytical writing skills.',
    icon: FileText,
  },
  {
    title: 'Dojo Drills',
    description: 'Challenge yourself with randomized drills to test your knowledge across all units.',
    icon: Target,
  },
  {
    title: 'Create a Quiz',
    description: 'Build custom quizzes tailored to your learning needs and focus areas.',
    icon: PlusCircle,
  },
  {
    title: 'Belt System',
