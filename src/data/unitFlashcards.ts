...
const lesson2_1: UnitFlashcardData[] = [
  ...
  { id: 'u2m-2.1-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Draw the circular flow model for households and firms.', back: 'Show two sectors: households and firms. Households supply labor/land/capital to firms (factor market) and receive income; households demand goods and services from firms (product market) and spend income. Firms supply goods and pay factor payments. Money and goods flow in opposite directions.', backImage: GRAPH_CARD_BACK_IMAGE },
...
const lesson2_3: UnitFlashcardData[] = [
  ...
  { id: 'u2m-2.3-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Draw a graph showing the relationship between unemployment and real GDP over the business cycle.', back: 'As real GDP falls during a recession, unemployment rises (inverse relationship). Show unemployment on one axis and time or real GDP on the other; unemployment peaks at the trough of the business cycle.', backImage: GRAPH_CARD_BACK_IMAGE },
...
const lesson2_4: UnitFlashcardData[] = [
  ...
  { id: 'u2m-2.4-g2', type: 'rapid-fire', tag: 'GRAPH', front: 'Show how to find the inflation rate between two years using a CPI graph.', back: 'Plot CPI for year 1 and year 2. Inflation rate = ((CPI2 - CPI1) / CPI1) × 100. The slope or gap between the two points shows the rate of price increase.', backImage: GRAPH_CARD_BACK_IMAGE },
];
...
const lesson2_7: UnitFlashcardData[] = [
  ...
  { id: 'u2m-2.7-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Draw the business cycle: expansion, peak, contraction, trough.', back: 'Plot real GDP (or output) on the vertical axis and time on the horizontal axis. Draw a wave: rising expansion to a peak, then falling contraction to a trough, then expansion again. Label the four phases.', backImage: GRAPH_CARD_BACK_IMAGE },
  { id: 'u2m-2.7-g2', type: 'rapid-fire', tag: 'GRAPH', front: 'Draw the business cycles graph and add a point that shows the economy with actual unemployment less than the natural rate of unemployment.', back: 'Draw the business cycle wave. Potential output (or full-employment output) is a horizontal line through the middle—the economy fluctuates around it. During expansion the economy may exceed potential (inflationary gap); at the trough it is below potential (recessionary gap).', backImage: GRAPH_CARD_BACK_IMAGE },
];
...
const lesson3_2: UnitFlashcardData[] = [
  ...
  { id: 'u3m-3.2-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the effect of a decrease in government spending on AD-AS.', back: 'AD shifts right. The horizontal shift in real GDP is larger than the initial change in G because of the multiplier: ΔY = multiplier × ΔG. Draw AD shifting right; the distance of the shift in output reflects the multiplied effect.', backImage: GRAPH_CARD_BACK_IMAGE },
  { id: 'u3m-3.2-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the impact of a decrease in consumer and business confidence on AD-AS graph.', back: 'AD shifts right. The horizontal shift in real GDP is larger than the initial change in G because of the multiplier: ΔY = multiplier × ΔG. Draw AD shifting right; the distance of the shift in output reflects the multiplied effect.', backImage: GRAPH_CARD_BACK_IMAGE },
];
...
const lesson3_3: UnitFlashcardData[] = [
  ...
  { id: 'u3m-3.3-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the impact of government subsidies of the SRAS curve.', back: 'Shift the SRAS curve to the left. This can be caused by increases in input prices (wages, energy), negative productivity shocks, or unfavorable regulations.', backImage: `${FLIPPABLE_BASE_URL}sras_decrease.jpg`},
];
...
const lesson3_7: UnitFlashcardData[] = [
  ...
  { id: 'u3m-3.7-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'How do you show long-run self-adjustment from a recessionary gap?', back: 'SRAS shifts right (due to falling wages) until it intersects AD at the LRAS level. The economy returns to potential output, but at a lower price level.', backImage: `${FLIPPABLE_BASE_URL}self_adjustment_recessionary.jpg` },
];
...
const lesson3_8: UnitFlashcardData[] = [
  ...
  { id: 'u3m-3.8-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'How do you show expansionary fiscal policy on an AD-AS graph?', back: 'AD shifts right due to increased government spending or decreased taxes. In the short run, this increases both price level and real GDP.', backImage: `${FLIPPABLE_BASE_URL}expansionary_fiscal.jpg` },
];
...
const lesson4_5: UnitFlashcardData[] = [
  ...
  { id: 'u4m-4.5-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show how an increase in the general price level impacts money demand.', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate and increases the quantity of money demanded.', backImage: `${FLIPPABLE_BASE_URL}money_supply_increase.jpg` },
  { id: 'u4m-4.5-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show how a decrease in national income impacts money demand.', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate and increases the quantity of money demanded.', backImage: `${FLIPPABLE_BASE_URL}money_supply_increase.jpg` },
  { id: 'u4m-4.5-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show how an increase in the general price level impacts money demand.', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate and increases the quantity of money demanded.', backImage: `${FLIPPABLE_BASE_URL}money_supply_increase.jpg` },
  { id: 'u4m-4.5-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show ', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate and increases the quantity of money demanded.', backImage: `${FLIPPABLE_BASE_URL}money_supply_increase.jpg` },
];
...
const lesson4_6: UnitFlashcardData[] = [
  ...
  { id: 'u4m-4.6-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'How do you show expansionary monetary policy on a money market graph?', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate, which increases investment and aggregate demand.', backImage: `${FLIPPABLE_BASE_URL}expansionary_monetary.jpg` },
  { id: 'u4m-4.6-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Draw the ample reserves graph with correct labels.?', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate, which increases investment and aggregate demand.', backImage: `${FLIPPABLE_BASE_URL}expansionary_monetary.jpg` },
  { id: 'u4m-4.6-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the ample reserves graph when the central bank decreases the Discount Rate and IOR rate.', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate, which increases investment and aggregate demand.', backImage: `${FLIPPABLE_BASE_URL}expansionary_monetary.jpg` },
  { id: 'u4m-4.6-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the ample reserves graph when the central bank decreases the Discount Rate and IOR rate.', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate, which increases investment and aggregate demand.', backImage: `${FLIPPABLE_BASE_URL}expansionary_monetary.jpg` },
  { id: 'u4m-4.6-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the impact of contractionary monetary policy on the ample reserves graph.', back: 'Shift the money supply curve to the right. This lowers the equilibrium interest rate, which increases investment and aggregate demand.', backImage: `${FLIPPABLE_BASE_URL}expansionary_monetary.jpg` },
];
...
const lesson4_7: UnitFlashcardData[] = [
  ...
  { id: 'u4m-4.7-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'How do you show the impcact of government deficit spending on a loanable funds graph?', back: 'Shift the demand for loanable funds curve to the right. This increases the real interest rate and the quantity of loanable funds, crowding out some private investment.', backImage: `${FLIPPABLE_BASE_URL}budget_deficit_loanable.jpg` },
  { id: 'u4m-4.7-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show what happens on the loanable funds graph when the actual RIR is lower than the equilibrium RIR.', back: 'Shift the demand for loanable funds curve to the right. This increases the real interest rate and the quantity of loanable funds, crowding out some private investment.', backImage: `${FLIPPABLE_BASE_URL}budget_deficit_loanable.jpg` },
  { id: 'u4m-4.7-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the impact of political instability on the loanable funds graph.', back: 'Shift the demand for loanable funds curve to the right. This increases the real interest rate and the quantity of loanable funds, crowding out some private investment.', backImage: `${FLIPPABLE_BASE_URL}budget_deficit_loanable.jpg` },
];
...
const lesson5_3: UnitFlashcardData[] = [
  ...
  { id: 'u5m-5.3-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the impact of expansionary fiscal policy on the price level and output of a country in the long-term.', back: 'Plot money growth rate on one axis and inflation rate on the other (or both over time). In the long run they move together: higher money growth leads to higher inflation. Approximately a 45-degree line if growth in V and Y are stable.', backImage: GRAPH_CARD_BACK_IMAGE },
];
...
const lesson5_7: UnitFlashcardData[] = [
  ...
  { id: 'u5m-5.7-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show how an increase in investment (e.g., from tax incentives) affects the loanable funds market and LRAS.', back: 'In loanable funds: demand for loanable funds could shift right (more investment demand) or supply could shift right (saving incentives). In AD-AS: over time, more investment in capital and R&D shifts LRAS right, increasing potential output.', backImage: GRAPH_CARD_BACK_IMAGE },
];
...
const lesson6_6: UnitFlashcardData[] = [
  ...
  { id: 'u6m-6.6-g1', type: 'rapid-fire', tag: 'GRAPH', front: 'Show the impact of an increase in interest rates on the value of the YEN relative to the EURO.', back: 'Higher interest rates in Japan attract capital inflows into Japan, increasing demand for the yen. In the market for yen (e.g. EUR/JPY), demand for yen shifts right, causing the yen to appreciate relative to the euro. The euro depreciates relative to the yen.', backImage: GRAPH_CARD_BACK_IMAGE },
];
