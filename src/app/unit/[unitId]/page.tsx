...
export default function UnitPage() {
  ...
  const handleUnitChange = (unitNumber: string) => {
    const isLocked = unitNumber === '5' || unitNumber === '6';
    if (isLocked) return; // Do nothing if the unit is locked
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-12 mt-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className={`text-5xl sm:text-6xl font-extrabold tracking-tight text-gray-800 mt-2`}>
            Unit <span className={`text-${themeColor}-500`}>Cheat Sheets</span>
          </h1>
          <p className="text-lg text-gray-600 mt-4">Key terms, formulas, and graphs for every unit.</p>
        </div>
