...
export default function StudyGuidePage() {
  ...
  useEffect(() => {
    ...
    const structuredData = {
      ...
      name: `AP ${guide.subject} Unit ${guide.unitNumber} Study Guide: ${guide.title}`,
      description: `Free AP ${guide.subject} Unit ${guide.unitNumber} study guide covering ${guide.title}. Download PDF cheat sheets, review key terms, formulas, and graphs.`,
      educationalLevel: 'High School',
      learningResourceType: 'Study Guide',
      about: {
        '@type': 'Thing',
        name: `AP ${guide.subject}`,
      },
      teaches: guide.title,
