...
export default function PurchaseExams() {
  ...
  } else if (isClient && guestSubject) {
    effectiveSubject = guestSubject;
  }

  if (loadingUserData || !isClient) {
    return (
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-4 md:p-8">
            ...
            <div className="mb-16">
              <h1 className="text-6xl font-extrabold tracking-tight text-center leading-tight">
                Full-Length <br></br><span className={effectiveSubject === 'macro' ? "text-blue-600" : "text-green-600"}>AP {pageTitleSubject}</span>
                <br />
                Practice Exams
              </h1>
