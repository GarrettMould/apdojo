        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-16">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-2xl font-extrabold tracking-tight">Multiple Choice Exams (MCQs)</h3>
                  ...
                  <div className="p-6 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        <span className="bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-sm text-sm font-semibold">$20</span>
                    ...
                    <div className="flex items-center gap-3">
                      <button 
                        ...
                        className="bg-gray-50 text-gray-900 px-6 py-2.5 rounded-lg hover:bg-gray-100 transition-colors font-medium border border-gray-200"
                      >
                        Purchase
                      </button>
                      <Link 
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-semibold">Free Response Exams (FRQs)</h3>
              <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-sm">
                <svg className="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
              ...
              {[1, 2, 3].map((num) => (
                ...
                >
                  ...
                  <button 
                    ...
                    className="w-full bg-gray-50 text-gray-900 px-6 py-2.5 rounded-lg hover:bg-gray-100 transition-colors font-medium border border-gray-200"
                  >
                    Purchase
                  </button>
                </div>
